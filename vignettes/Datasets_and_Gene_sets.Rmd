...
Raw datasets are available from the repositories reported in the original publications and Table S1. Processed datasets and curated gene and gene-set resources are available from [Figshare](https://doi.org/10.6084/m9.figshare.31839988).
