...
- lasso_para:
  ...
  data_format: Format of spatial data, One of "square_grid", "hex_grid",
  or "single_cell". (default: "square_grid") - data_platform: Platform
  of spatial data, either "StereoSeq" or "Visium" (default:
  "StereoSeq") - binsize: Bin size for spatial data (default: 1) -
